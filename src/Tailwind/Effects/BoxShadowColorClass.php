...
class BoxShadowColorClass extends AbstractTailwindClass
{
    ...
    {
        if (preg_match('/^shadow-((?:\[.+\]|inherit|current|transparent|black|white|slate|gray|zinc|neutral|stone|red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)(?:-\d{1,3})?(?:\/[0-9]+)?)$/', $class, $matches)) {
            $value = $matches[1];
