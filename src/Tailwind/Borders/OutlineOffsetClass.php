...
class OutlineOffsetClass extends AbstractTailwindClass
{
    private $isArbitrary;
    ...
    public function toCss(): string
    {
        ...
        return ".outline-offset-{$classValue}{outline-offset:{$offsetValue};}";
    }
    ...
    private function getOffsetValue(): string
    {
        ...
        return $outlineOffsets[$this->value] ?? $this->value;
    }
    ...
    {
        if (preg_match('/^outline-offset-(.+)$/', $class, $matches)) {
            $value = $matches[1];
