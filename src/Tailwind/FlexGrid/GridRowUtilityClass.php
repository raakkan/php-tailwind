...
class GridRowUtilityClass extends AbstractTailwindClass
{
    private $isSpan;
    ...
    public function toCss(): string
    {
        ...
        return ".row-{$escapedValue}{{$property}:{$cssValue};}";
    }
    ...
    {
        if (preg_match('/^row-(span-\d+|start-(\d+|\[.+\]|auto)|end-(\d+|\[.+\]|auto)|auto|span-full|\[.+\])$/', $class, $matches)) {
